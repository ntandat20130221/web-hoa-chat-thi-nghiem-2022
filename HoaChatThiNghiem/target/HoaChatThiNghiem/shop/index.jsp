                        ...
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link active" data-toggle="tab" href="#hoa-chat" role="tab">Hóa chất</a>
                                </li>
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link" data-toggle="tab" href="#dung-cu" role="tab">Dụng cụ</a>
                                </li>
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link" data-toggle="tab" href="#thiet-bi" role="tab">Thiết bị</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/hoa_chat/acid_bazo/acid_vo_co/550x750/hydrochloric.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/hoa_chat/muoi/muoi_huu_co/550x750/muoi-huu-co-1.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/hoa_chat/muoi/muoi_vo_co/550x750/muoi-vo-co-1.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/hoa_chat/hoa_chat_hoa_sinh/550x750/hoa-sinh-2.jpg" alt="#" />
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/dung_cu/binh_thi_nghiem/550x750/binh-thi-nghiem-1.png" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/dung_cu/giay_loc_mang_loc/dinh_tinh/550x750/giay-loc-dinh-tinh-1.png" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/dung_cu/giay_loc_mang_loc/dinh_luong/550x750/giay-loc-dinh-luong-1.png" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/thiet_bi/kinh_hien_vi/sinh_hoc/550x750/kinh-hien-vi-sinh-hoc-1.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/thiet_bi/lo_nung/duoi_1000_do/550x750/lo-nung-duoi-1000-1.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/thiet_bi/lo_nung/tren_1000_do/550x750/lo-nung-tren-1000-1.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/thiet_bi/may_cat_nuoc/550x750/may-cat-nuoc-1.jpg" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.jsp">
                                                        <img class="default-img" src="../images/thiet_bi/kinh_hien_vi/noi_soi/550x750/kinh-noi-soi-noi-1.png" alt="#" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/thiet_bi/kinh_hien_vi/huynh_quang/115x140/kinh-huynh-quang-1.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Kính hiển vi điện tử</a>
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/dd_dem/115x140/dung-dich-dem-1.png" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Dung dịch đệm</a>
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/bazo/115x140/bazo-1.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Bazo</a>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/bazo/115x140/calcium-hydroxide.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Calcium Hydroxide</a>
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/bazo/115x140/sodium-hydroxide.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Sodium Hydroxide</a>
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/acid_vo_co/115x140/axit-sunfuric.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Acid Sunfuric 95%</a>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/acid_vo_co/115x140/hydrochloric.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Acid Hydrochloric 89%</a>
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/acid_vo_co/115x140/sodium-sulfite.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Sodium Sulfite</a>
                    ...
                    <div class="single-list">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image">
                                    <a href="product-details.jsp"><img src="../images/hoa_chat/acid_bazo/acid_vo_co/115x140/acid-vo-co-1.jpg" alt="#" /></a>
                                    <a href="product-details.jsp" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="content pt-5">
                                    <a class="pname" href="product-details.jsp">Acid Vô Cơ</a>
                                    <p class="price">990,000đ</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="image">
                        <img src="../images/hoa_chat/thuoc_thu/750x590/thuoc-thu-2.jpg" alt="#" />
                    </div>
                </div>
                <div class="col-lg-6 col-12">
                    <div class="content">
                        <div class="heading-block">
                            ...
                            <h3 class="title">Thuốc thử nguyên chất</h3>
                            <p>
                                Thuốc thử nguyên chất Calsio Delatiumn 120-26P 15% được sản
                                xuất theo tiêu chuẩn quốc tế IAEA đảm báo chất lượng 100%.
                            </p>
                            <h1 class="price">660,000đ <s>900,000đ</s></h1>
