...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar-user"><img class="admin-avatar" src="https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="User Image">
            ...
            <p class="app-sidebar-user-designation">Chào mừng bạn trở lại</p>
        </div>
        <hr>
        <ul class="app-menu">
            <li>
            ...
            <li>
                <a class="app-menu-item active" href="product-manager.jsp"><i class='bx bx-purchase-tag-alt'></i>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <a class="btn btn-cancel" href="product-manager.jsp">Hủy bỏ</a>
                </div>
    </main>
